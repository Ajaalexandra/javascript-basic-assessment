...
// #9 Write a function called addItem that takes in an array and an item, adds the item to the array, and returns the array with the added item.

function addItem(myArray, item) {
    myArray.push(item); {
			return myArray;
	}
